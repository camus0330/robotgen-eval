...
gpt_/.tools/venv/bin/python gpt_/gorilla8/src/simulate.py \
  --motion gpt_/gorilla8/output/motions/flat_palm_swing/motion.npz \
  --out gpt_/gorilla8/output/simulation_runs/flat_palm_swing_release \
  --gravity-feedforward --render
gpt_/.tools/venv/bin/python gpt_/gorilla8/src/simulate.py \
  --motion gpt_/gorilla8/output/motions/flat_palm_wave/motion.npz \
  --out gpt_/gorilla8/output/simulation_runs/flat_palm_wave_release --render
```

实际CAD检查要求trace绝对路径，例如从仓库根目录：

```bash
gpt_/.tools/venv/bin/python gpt_/gorilla8/src/verify_assembly.py --exhaustive-exact \
  --simulation-trace "$PWD/gpt_/gorilla8/output/simulation_runs/flat_palm_swing_release/trace.json" \
  --report gpt_/gorilla8/reports/flat_swing_simulation_collision.json
gpt_/.tools/venv/bin/python gpt_/gorilla8/src/verify_assembly.py --exhaustive-exact \
  --simulation-trace "$PWD/gpt_/gorilla8/output/simulation_runs/flat_palm_wave_release/trace.json" \
  --report gpt_/gorilla8/reports/flat_wave_simulation_collision.json
```

媒体检查和代表帧导出：

```bash
gpt_/.tools/venv/bin/python gpt_/gorilla8/src/verify_media.py \
  --run gpt_/gorilla8/output/simulation_runs/flat_palm_swing_release --frames 4.8 8 15
gpt_/.tools/venv/bin/python gpt_/gorilla8/src/verify_media.py \
  --run gpt_/gorilla8/output/simulation_runs/flat_palm_wave_release --frames 4.92 7.16 14
```
