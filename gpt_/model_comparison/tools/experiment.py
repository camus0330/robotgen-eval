...
def prepare_inputs(home=KIT_ROOT, workspace=WORKSPACE):
    ...
    bench = workspace / 'gorilla8/benchmark'
    pairs += [(bench / 'profile.json', 'motion_profile.json'),
              ...
              (bench / 'runs/20260920/environment.lock.txt', 'environment.lock.txt'),
              (workspace / 'xl330_m288_t/xl330_m288_t.step', 'assets/xl330_m288_t.step'),
              (workspace / 'ChatGPT Image 2026年9月16日 16_31_44 (3).png', 'assets/reference.png')]
