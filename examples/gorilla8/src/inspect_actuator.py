...
def main():
    ...
    parser.add_argument("--step", type=Path, default=root / "data/xl330_m288_t.step")
    parser.add_argument("--metadata", type=Path, default=root / "data/xl330_m288_t_assembly.json")
    default_robot = root / "gorilla8" if (root / "gorilla8").is_dir() else root / "examples/gorilla8"
    parser.add_argument("--output", type=Path, default=default_robot / "reports/actuator_geometry.json")
